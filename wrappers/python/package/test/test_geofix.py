...
def test_geofix():
    # Use constructor with False to suppress log messages
    ...
    assert math.floor(result['center'][0]) == 48
    assert os.environ['COMMIT_HASH'] == dfAnalyzer.get_commit_hash() or os.environ['COMMIT_HASH'] == '--hash--'
